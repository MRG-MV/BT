    ...
    connectedCallback() {
        ...
        if (this.SchedulerId == null || this.SchedulerId == undefined) {
          if(this.recordId == null || this.recordId == undefined){
              this.SchedulerId = 'a101K00000GocLcQAJ'
          }else{
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  var iconElement = `<div>Test</div><span class="slds-icon_container slds-icon-custom-custom8" style="background:white;">
             ...
             <path fill="#FFFFFF" d="M47,21.3l-24,26c-1.4,1.5-1.4,3.9,0,5.4l24,26c1.6,1.7,4.3,1.7,5.9,0l24-26c1.399-1.5,1.399-3.9,0-5.4
                ...
                console.log('else if one for arrow right');
                if (
                  record.record._data.name == "Milestone Complete" ||
                  record.record._data.customtype == "Milestone"
                ) {
                    console.log('if Milestone two for arrow right');
                  var iconElement = `<div>Test</div><span class="slds-icon_container slds-icon-custom-custom8" style="background:white;">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                  width="100px" height="100px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
             <path fill="#FFFFFF" d="M47,21.3l-24,26c-1.4,1.5-1.4,3.9,0,5.4l24,26c1.6,1.7,4.3,1.7,5.9,0l24-26c1.399-1.5,1.399-3.9,0-5.4
                 l-24-26C51.3,19.6,48.6,19.6,47,21.3z"/>
                  ...
                  if (record.row._allCells[5].children[0]) {
                    console.log('if if children for arrow right');
                    if (
                      record.row._allCells[5].children[0].innerHTML.indexOf(
                        "slds-icon-custom-custom8"
                      ) == -1
                    ) {
                        console.log('if slds-icon-custom for arrow right');
                      record.row._allCells[5].children[0].innerHTML =
                        iconElement + record.row._allCells[5].children[0].innerHTML;
                        console.log(record.row._allCells[5].children[5]);
                    }
                  }
                } else {
                    console.log('else one for arrow right');
                  var iconElement = `<span class="slds-icon_container slds-icon-standard-task2" style="background:orange;">
                    ...
                    console.log('record.row._allCells:- ',record.row._allCells);
                    console.log('record.row._allCells[5]:- ',record.row._allCells[5].children);
                    console.log('record.row._allCells[5].children[0]:- ',record.row._allCells[5].children);
                    console.log('record.row._allCells[5].children[0].innerHTML:- ',record.row._allCells[5].children[0].innerHTML);
                  if (record.row._allCells[5].children[0]) {
                    console.log('else children for arrow right');
                    if (
                      record.row._allCells[5].children[0].innerHTML.indexOf(
                        "slds-icon-standard-task2"
                      ) == -1
                    ) {
                        console.log('else slds-icon-standard for arrow right');
                      record.row._allCells[5].children[0].innerHTML =
                        iconElement + record.row._allCells[5].children[0].innerHTML;
                        console.log(record.row._allCells[5].children[5]);
